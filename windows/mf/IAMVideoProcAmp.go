...
func (i *IAMVideoProcAmp) Set(Property consts.VideoProcAmpProperty, lValue, Flags int32) error {
...
func (i *IAMVideoProcAmp) Get(Property consts.VideoProcAmpProperty) (value int32, flags int32, err error) {
